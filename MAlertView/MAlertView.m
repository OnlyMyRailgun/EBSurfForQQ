...
#define kMAlertViewTextFieldHeight 32.0
#define kMAlertViewMargin 6.0
...
- (void)layoutSubviews{
    ...
    for (UIView *view in self.subviews) {
        ...
        if ([view isKindOfClass:[UIImageView class]]) {
            ...
            rect = view.frame;
            rect.size.width = self.bounds.size.width - 4*kMAlertViewMargin;
            rect.size.height = kMAlertViewTextFieldHeight;
            rect.origin.x = kMAlertViewMargin*2;
